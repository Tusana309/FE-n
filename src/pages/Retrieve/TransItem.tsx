    ...
    <div className='py-3 px-4 bg-[#ecf8ff] shadow-md rounded-lg mt-4' key={index}>
      <div className='flex justify-between'>
        ...
        <div className='flex items-center gap-2'>
          <p className='text-[#03121a] font-bold'>{_.transportations?.price} VND</p>
          <div className='cursor-pointer' onClick={() => handleChat(_.transportations?.user_id)}>
            <svg
      ...
      <div className='flex gap-2 items-center'>
        <div className='flex flex-col'>
          <div className='flex gap-2 items-center'>
            ...
            <p className='text-[#03121a] font-bold'>{_.transportations?.tranportation_name}</p>
          </div>
          <p>
