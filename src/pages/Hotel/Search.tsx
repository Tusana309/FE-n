...
export const Start = () => {
  return (
    <div className='flex items-center'>
      ...
      <img src='https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/5/50ebd00a57a4a3f5c2414dab877609f6.svg' alt='' />
    </div>
  )
}
              ...
              <div className='grid mb-4 grid-cols-4 gap-3 shadow-md rounded-md overflow-hidden' key={index}>
                <div className='col-span-1 rounded-md flex flex-col gap-1'>
                  <div className='rounded-md w-full h-full'>
                    <img className='w-full object-cover object-center h-full' src={item.hotel_img} alt='' />
                  </div>
                  <div className='grid gap-1 grid-cols-3'>
                    {Array(3)
                      .fill(0)
                      .map((_, index) => (
                        <div className='rounded-md col-span-1 w-full h-full' key={index}>
                          <img className='w-full object-cover object-center h-full' src={item.hotel_img} alt='' />
                        </div>
                      ))}
                  </div>
                ...
                <div className='col-span-2'>
                  <div className='flex gap-2 items-center'>
                    <p className='text-[#03121a] font-bold mb-3'>{item.hotel_name}</p>
                    <div className='cursor-pointer mb-3 chat-abc' onClick={() => handleChat(item.user_id)}>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='white'
                        viewBox='0 0 24 24'
                  ...
                  <div className='flex items-center gap-1'>
                    ...
                    <p className='text-[14px] text-[#0264c8] font-semibold'>Khách sạn</p>
                    <Start />
                  </div>
