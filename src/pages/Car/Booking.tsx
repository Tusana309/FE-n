...
import { getCarId } from 'src/apis/car.api'
        ...
        <div className='mx-auto px-4 flex max-sm:flex-col sm:pt-[140px] max-w-[1200px]'>
          <div className='sm:w-2/3'>
            <div>
              ...
              <div className='p-4 rounded-md shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]'>
                ...
                <div className='flex gap-4 mt-4'>
                  <div className='flex flex-col w-1/2'>
                    <label htmlFor='' className='text-[#03121a] text-[14px] font-bold'>
                      Loại xe: {location.state.seater} chỗ
                    </label>
                  </div>
                </div>
              <div className='flex gap-4 mt-4'>
                  <div className='flex flex-col w-1/2'>
                    <label htmlFor='' className='text-[#03121a] text-[14px] font-bold'>
                      Ngày nhận xe: {formatDate(location.state.date)}
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div className='mt-4'>
              ...
              <div className='p-4 rounded-md shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] flex'>
          ...
          <div className='ml-4 sm:w-1/3 max-sm:mt-8'>
            <div className='p-4 bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-t-xl'>
              ...
              {/* <p className='text-[#03121a] text-[16px] font-medium'>{result?.data.result[0].car_name}</p> */}
              <div className='cursor-pointer mb-3' onClick={() => handleChat(result?.data.result[0].user_id)}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='white'
                  viewBox='0 0 24 24'
            ...
            <div>
              <img src={result?.data.result[0].car_img} alt='' className='w-full h-full' />
            </div>
